...
<pbox>
<phead>
<up>The presence of White students and the emergence of Black-White within-school inequalities: two interaction-based mechanisms.</up>
<br>
<p1>Joao Souto-Maior.</p1> 2022. *Job market paper.* 
<br>
<left style="float: left">
<button onclick="readMore1('1')" class="button" style="float: left">DETAILS</button>
<a href="https://arxiv.org/pdf/2304.04849.pdf" target="_blank" class = "a3">PDF</a>
</left>
</phead>
<br>
...
<br>
<p1>Joao Souto-Maior</p1> & Ravi Shroff. 2022.
<br>
<left style="float: left">
...
<pbox>
<phead>
<up>Hoarding without hoarders: unpacking the emergence of opportunity hoarding within schools</up>
<br>
<p1>Joao Souto-Maior.</p1> *Expected submission: Spring 2023*
<br>
<left style="float: left">
...
<br>
Hank Sherwood, <p1>Joao Souto-Maior</p1>, Paul Poteat, Hirokazu Yoshikawa, Jerel Calzo. *Expected submission: Spring 2023* 
<br>
<left style="float: left">
...
<pbox>
<phead>
<up>Unpacking the emergence of opportunity hoarding: an agent-based model of Black-White educational disparities within schools</up>
<br>
<p1>Joao Souto-Maior.</p1> *Annual Conference of the International Network of Analytical Sociologists at Princeton University (expected)*. 2023
</phead>
</pbox>
