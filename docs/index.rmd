...
<div class="parentbox">
<div class="cardtopic">
<p3>A complex systems approach to questions in the sociology of education <br> (color code = <i class="fa-solid fa-circle" style="color:#d4a373; font-size: 9pt"></i>)</p3>
<br>
<moredetails>
...
<div class="cardtopic">
<titleboxtopic>
<p3>Rethinking the analysis of bias in student sorting processes <br> (color code = <i class="fa-solid fa-circle" style="color:#457b9d; font-size: 9pt"></i>)</p3>
</titleboxtopic>
<moredetails>
...
<p1> Peer-reviwed publications </p1>
...
<br>
<me>Joao Souto-Maior</me> and Ravi Shroff (2023). *Conditionally accepted at Sociological Science*.
<br>
<left>
<button onclick="readMore1('2')" class="button" style="float: left">more</button>
<a href="https://arxiv.org/pdf/2306.15075.pdf" target="_blank" class = "a2">arXiv preprint of prior version</a>
<i class="fa-solid fa-circle" style="color:#457b9d; font-size: 9pt"></i>
</left>
</titlebox>
<br>
...
<a href="https://arxiv.org/pdf/2304.04849.pdf" target="_blank" class = "a2">arXiv preprint</a>
<i class="fa-solid fa-circle" style="color:#d4a373; font-size: 9pt"></i>
</left>
</titlebox>
<br>
<span class="dots"></span><span class="more" style="display: none">
...
<a href="https://arxiv.org/pdf/2305.14653.pdf" target="_blank" class = "a2">arXiv preprint</a>
<i class="fa-solid fa-circle" style="color:#d4a373; font-size: 9pt"></i>
</left>
</titlebox>
<br> 
...
<br>
<left>
<button onclick="readMore1('4')" class="button" style="float: left">more</button>
<i class="fa-solid fa-circle" style="color:#457b9d; font-size: 9pt"></i>
</left>
</titlebox>
<br> 
