...
<br>
&emsp; <i class="fa-solid fa-book" style="font-size: 8pt"></i> Social and racial inequality
<br>
...
<br>
<me>Joao Souto-Maior</me>. Forthcoming. *The Journal of Mathematical Sociology*.
<br>
<left>
...
<titlebox>
<p3>The correlated proxy problem: why control variables can obscure the contribution of selection processes to group-level inequality <span style="display: inline-block; width: 10px; height: 10px; background-color: blue; border-radius: 50%; vertical-align: middle;"></span></p3>
<br>
<me>Joao Souto-Maior</me>, Kenneth Shores and Rachel Fish. *Under Review*.
<br>
<left>
