...
I am a Ph.D. Candidate in [Sociology of Education program](https://steinhardt.nyu.edu/programs/sociology-education) in the Department of Applied Statistics, Social Science and Humanities at New York University's Steinhardt School of Culture, Education and Human Development at the New York University. I am interested in understanding how the organization of schools influence the learning experiences of students and how it shapes the emergence of within-school educational inequalities along dimensions of race and class. My research applies rigorous computational  methods — ranging from qualitatively-informed agent-based models to machine-learning approaches — in innovative and creative ways to enhance the knowledge of school organization on two fronts. One, on the investigation of the mechanisms through which organizational practices shape students’ educational experiences, advancing the explanatory commitment of sociological analysis often termed under the field of “analytical sociology”. Two, on the production of rigorous and empirically-driven evaluations of selected organizational practices.
...
<pbox>
<phead>
<up>Black-White advanced enrollment inequalities and the share of White students in school: an agent-based modeling investigation</up>
<br>
<p1>Joao Souto-Maior.</p1> *Submitted: July, 2022*
<br>
...
<pmain>
**Abstract:** This article investigates mechanism-based explanations for a puzzling finding in the sociology of education, namely, that Black-White unequal access to educational resources --- defined as advanced coursework --- is the highest in racially diverse and majority-White schools. Because relative group size is known to influence the probability of same-race ties, this study considers the hypothesis that this compositional effect operates through the influence of the racial composition of schools on informal, interaction-dependent, process shaping student advanced enrollment. I construct a qualitatively informed agent-based model which explores how the share of White students in the school shapes two particular informal processes: students' peer culture and parents' opportunity hoarding. The model is endowed with empirically calibrated social networks and is validated against a sample of US public schools. Simulation-based experiments show that both informal processes considered here tend to produce higher enrollment inequalities between comparable Black and White students as the share of White students in the school increases. Results shed light into policy strategies to improve the educational experiences of Black students in majority-White schools. At a methodological level, the study illustrates the promise of agent-based modelling investigations to better understand the complex informal dynamics of school organizations.
</pmain>
</pbox>
</span>
</div>
...
<pbox>
<phead>
<up>The limited role of academic preparedness in explaining Black-White enrollment disparities in advanced high school coursework </up>
<br>
<p1>Joao Souto-Maior</p1> & Ravi Shroff. *Submitted: July, 2022*
<br>
<left style="float: left">
...
<br>
<p1>Joao Souto-Maior.</p1> *Expected submission: August, 2022*
<br>
<left style="float: left">
...
<br>
Hank Sherwood, <p1>Joao Souto-Maior</p1>, Paul Poteat, Hirokazu Yoshikawa, Jerel Calzo. *Expected submission: Sep., 2022* 
<br>
<left style="float: left">
...
<up>Black-White advanced enrollment inequalities and the racial composition of schools: an agent-based modeling investigation</up>
<br>
<p1>Joao Souto-Maior.</p1> *The Seventh Joint US-Japan Conference on Mathematical Sociology and Rational Choice, Upcoming*. 2022.
</phead>
</pbox>
...
<subheading>Laboratory sections</subheading>
