...
<titlebox>
<p3>The correlated proxy problem: why control variables can obscure the contribution of selection processes to proup-level inequality <span style="display: inline-block; width: 10px; height: 10px; background-color: blue; border-radius: 50%; vertical-align: middle;"></span></p3>
<br>
