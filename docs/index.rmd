...
<br>
 New York University
<br>
<a href="files/JSM_cv_public-version.pdf" target="_blank" class = "a2" >cv</a>
<a href="https://github.com/joaosoutomaior/" target="_blank" class = "a2" >GitHub</a>
<a href="https://scholar.google.com/citations?user=z231epEAAAAJ&hl=pt-BR&oi=ao" target="_blank" class = "a2">Google Scholar</a>
</center>
</div>
...
<i class="fa-solid fa-book"></i> Organizations
<br>
<i class="fa-solid fa-book"></i> Education policy
<br>
<i class="fa-solid fa-book"></i> Racial inequality
<br>
<i class="fa-solid fa-book"></i> Computational methods

###

<p1>Education</p1>

<i class="fa-solid fa-graduation-cap"></i> Ph.D. Sociology of Education --- 2023
<br>
<p2>&emsp; New York University</p2>
<br>
<i class="fa-solid fa-graduation-cap"></i> M.Phil. Sociology of Education --- 2021
<br>
<p2>&emsp; New York University</p2>
<br>
<i class="fa-solid fa-graduation-cap"></i> B.A. Economics with mathematical emphasis --- 2017
<br>
<p2>&emsp; University of Wisconsin-Madison</p2>
<br>
...
Website last updated on <script>
    document.write(new Date().toLocaleDateString('en-US')); </script>
</p>
...
In my research, I rely on innovative methodological approaches to re-examining “old” questions in education research. Doing so, I hope to improve the quality of evidence on some of the central questions to education policy and practice. In particular, I concentrate on questions related to the organization of educational institutions and how organizational decisions impact the formation of racial and socioeconomic inequalities in education opportunity. This work is defined by two main areas of research, detailed below.

<div class="parentbox">
<div class="cardfig" data-paper="1000">
<titlebox>
<p3><i class="fa-solid fa-circle" style="color:orange; font-size: 9px"></i> Bringing insights from complex systems to school organization research</p3>
<br>
<left>
...
<titlebox>
<p3><i class="fa-solid fa-circle" style="color:green; font-size: 9px"></i> Rethinking the analysis of bias in student sorting processes</p3>
<br>
<left>
...
<moredetails>
<br>
Among the central decisions which educational institutions have to make is the one of sorting students. Schools, for example, often need to decide which students are allowed to: pass courses, be promoted to a next-level grade; take certain courses. Similarly, selective institutions (such as selective high schools, and selective colleges and universities) need to sort students when admissions decisions, sorting the pool of applicants and into those who are offered admission and those who are not. One of my research focuses is to improve current methodological strategies to examine the possible existence of biases in these sorting processes.
</moredetails>
</textbox>
</span>
</div>
...
<i class="fa-solid fa-circle" style="color:orange; font-size: 9px"></i>
</left>
</titlebox>
<br>
<span class="dots"></span><span class="more" style="display: none">
...
<i class="fa-solid fa-circle" style="color:green; font-size: 9px"></i>
</left>
</titlebox>
<br>
<span class="dots"></span><span class="more" style="display: none">
...
.a2, .a2:link .a2:active, .a2:visited {
