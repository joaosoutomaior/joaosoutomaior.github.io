...
<titleboxsmall>
<p3>Bringing insights from complex systems to school organization research (color code = <i class="fa-solid fa-circle" style="color:#d4a373; font-size: 9pt"></i>)</p3>
<br>
<left>
