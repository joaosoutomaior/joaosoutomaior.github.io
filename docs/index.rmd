...
In what follows, I detail how my past, current, and planned research uses these methods to address the objectives listed above.
...
<p1> Research objectives </p1>

1. To understand the mechanisms through which organizations shape social stratification. 
 <span style="display: inline-block; width: 10px; height: 10px; background-color: orange; border-radius: 50%; vertical-align: middle;"></span>
2. To statistically identify biases in organizations’ selection processes. <span style="display: inline-block; width: 10px; height: 10px; background-color: blue; border-radius: 50%; vertical-align: middle;"></span>
