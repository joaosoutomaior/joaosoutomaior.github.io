...
I am a postdoctoral associate (effective August, 2023) in the [Institute of Human Development and Social Change](https://steinhardt.nyu.edu/ihdsc) at the New York University. I am on the 2023-24 job market.
...
<i class="fa-solid fa-book" style="font-size: 8pt"></i> Organizations
<br>
<i class="fa-solid fa-book" style="font-size: 8pt"></i> Education policy
<br>
<i class="fa-solid fa-book" style="font-size: 8pt"></i> Racial inequality
<br>
<i class="fa-solid fa-book" style="font-size: 8pt"></i> Computational methods

###

<p1>Education</p1>

<i class="fa-solid fa-graduation-cap" style="font-size: 8pt"></i> Ph.D. Sociology of Education --- 2023
<br>
<p2>&emsp; New York University</p2>
<br>
<i class="fa-solid fa-graduation-cap" style="font-size: 8pt"></i> M.Phil. Sociology of Education --- 2021
<br>
<p2>&emsp; New York University</p2>
<br>
<i class="fa-solid fa-graduation-cap" style="font-size: 8pt"></i> B.A. Economics with mathematical emphasis --- 2017
<br>
...
<i class="fa-solid fa-note-sticky" style="font-size: 8pt"></i> For research/publication purposes, I use a hyphenated version of my last name: Souto-Maior.
