...
&emsp; <i class="fa-solid fa-book" style="font-size: 8pt"></i> Sociology of Education
<br>
&emsp; <i class="fa-solid fa-book" style="font-size: 8pt"></i> Race and class inequality
<br>
...
* Group favoritism in student-sorting processes <span style="display: inline-block; width: 10px; height: 10px; background-color: blue; border-radius: 50%; vertical-align: middle;"></span>
* The role of social networks in generating educational inequalities.<span style="display: inline-block; width: 10px; height: 10px; background-color: orange; border-radius: 50%; vertical-align: middle;"></span>
...
<titlebox>
<p3>School racial composition and the emergence of Black-White within-school inequalities: network-based foundations <span style="display: inline-block; width: 10px; height: 10px; background-color: orange; border-radius: 50%; vertical-align: middle;"></span> </p3>
<br>
